...
parser.add_argument("--rec_loss", type=str, default="ssim", choices=("ssim", "bce", "l1"))
...
train_loader = DataLoader(get_dataset(dsize=args.size), batch_size=args.batch_size, shuffle=True)
test_loader = DataLoader(get_dataset(root="../data/test", dsize=args.size), batch_size=args.batch_size, shuffle=True)
